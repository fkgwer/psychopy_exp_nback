...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/wernstal/Library/Mobile Documents/com~apple~CloudDocs/Forskning/My PhD:Patrick Purdon/Code/Psychopy/1._n-back_latest_post_Alex_commemnts/n-back_post_Alex_comments_with_jitter_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # ------------------------------------------------------
    iti_fixed_duration = 1.0    # Fixed component of ITI in seconds, it already has a minimum trial duration of stimulus_duration, set in "code_iti_timing" in "n_back_trial" Routine
    iti_jitter_min = 0.0        # Minimum jitter in seconds (set both iti_jitter_min=iti_jitter_max=0 for fixed iti
    iti_jitter_max = 0.0        # Maximum jitter in seconds
