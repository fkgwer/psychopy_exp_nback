...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/wernstal/Library/Mobile Documents/com~apple~CloudDocs/Forskning/My PhD:Patrick Purdon/Code/Psychopy/1._n-back_latest_post_Alex_commemnts/n-back.py',
