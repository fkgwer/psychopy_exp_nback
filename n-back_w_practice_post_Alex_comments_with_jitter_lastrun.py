...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/wernstal/Library/Mobile Documents/com~apple~CloudDocs/Forskning/My PhD:Patrick Purdon/Code/Psychopy/1.n-back_w_practice_latest_post_Alex_commemnts/n-back_w_practice_post_Alex_comments_with_jitter_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # ------------------------------------------------------
    iti_fixed_duration = 1.25   # To test: 1.25, 1.75, 2.25
